    ...
    bool        store_contr_func) // number of columns this function works on
{
    ...
    if (store_contr_func) {
        ...
        if (iso)
            ...
            calculate_contribution_function_noniso(contr_func_band,
                                                   *trans_wg_upper,
                                                   *trans_wg_lower,
                                                   gauss_weight,
                                                   *planckband_lay,
...
void alfrodull_engine::calculate_contribution_function_iso(double* contr_func_band,
                                                           double* trans_wg,
                                                           double* gauss_weight,
...
void alfrodull_engine::calculate_contribution_function_noniso(double* contr_func_band,
                                                              double* trans_wg_upper,
                                                              double* trans_wg_lower,
                                                              double* gauss_weight,
                                                              double* planckband_lay,
...

    {
        ...
        calc_contr_func_noniso<<<gridsize, blocksize>>>(contr_func_band,
                                                        trans_wg_upper,
                                                        trans_wg_lower,
                                                        gauss_weight,
                                                        planckband_lay,
